...
BEGIN
    ...
    VALUES 
    (p_IdSorteo, p_Posicion, p_TipoProspecto, p_N1, p_N2, p_N3, p_N4, p_N5, p_Peso)
    ON CONFLICT ("IdSorteo", "Posicion", "TipoProspecto") DO NOTHING;
END 
$BODY$;
ALTER PROCEDURE public.insertar_prospectos_en_db(integer, integer, character varying, integer, integer, integer, integer, integer, double precision)
    OWNER TO postgres;
