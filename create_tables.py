...
DATABASE_URL = "postgresql://postgres:R1c4rd1t0%@localhost:5432/baloto"
...
sorteos_table = Table(
    ...
    Column('TipoSorteo', String, nullable=False),  # Ejemplo: 'Tr' o 'Re'
    ...
    Column('SB', Integer, nullable=True)  # Solo para sorteos con Super Balota
)
...
resultados_comparacion_table = Table(
    ...
    Column('Numero_Superbalota', Integer, nullable=True),  # Super Balota del sorteo
    Column('Superbalota_Acertada', String, nullable=True)  # Ejemplo: "Sí" o "No"
)
...
prospectos = Table(
    ...
    Column('SB', Integer, nullable=False),  # Número super baloto
